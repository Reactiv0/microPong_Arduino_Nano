...
<a id="chapter-0"></a>
## Описание проекта
- Миниатюрная игровая приставка с игрой Pong, построенная на Arduino Nano и OLED дисплее
- Страница оригинального проекта на сайте: https://alexgyver.ru/microPong/
...
* Открыть Инструменты/Плата/Arduino Nano
* Загрузить прошивку (Скетч/Загрузить)
